...
import com.s.k.starknight.StarKnight.Companion.underlyingNetwork
...
class SkVpnService : BaseVpnService(),
    ...
    override fun acquireWakeLock() {
        wakeLock = StarKnight.power.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "sagernet:vpn")
            .apply { acquire() }
    }
    ...
    override fun createNotification(profileName: String): ServiceNotification {
        return ServiceNotification(this, profileName, "service-vpn")
    }
    ...
    inner class NullConnectionException : NullPointerException(),
        ...
        override fun getLocalizedMessage() = getString(R.string.sk_reboot_required)
    }
...
//        val tunOptions = JSONObject(tunOptionsJson)
        ...
        val builder = Builder().setConfigureIntent(StarKnight.configureIntent(this))
            .setSession(getString(R.string.sk_app_name))
