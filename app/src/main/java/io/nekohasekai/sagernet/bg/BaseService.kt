    ...
    interface Interface {
        ...
        fun reload() {
            if (DataStore.selectedProxy == 0L) {
                stopRunner(false, (this as Context).getString(R.string.sk_profile_empty))
            }
        ...
        suspend fun preInit() {
            DefaultNetworkListener.start(this) {
                sk.connectivity.getLinkProperties(it)?.also { link ->
                    sk.underlyingNetwork = it
        ...
        fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
            ...
            if (profile == null) { // gracefully shutdown: https://stackoverflow.com/q/47337857/2245107
                data.notification = createNotification(getString(R.string.sk_app_name))
                stopRunner(false, getString(R.string.sk_profile_empty))
            ...
            runOnMainDispatcher {
                try {
                    ...
                    val title = if (config != null){
                        ...
                        getString(R.string.sk_app_name)
                    }
                    ...
                    stopRunner(false, getString(R.string.sk_invalid_server))
                    ...
                    stopRunner(
                        false, "${getString(R.string.sk_service_failed)}: ${exc.readableMessage}"
                    )
                } finally {
